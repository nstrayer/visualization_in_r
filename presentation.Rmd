...
Don't go nuts. Most likely the user will not understand the data you are showing at nearly the level you do, so something that may seem very intuitive to you may be entirely unintelligible to them.
...
If a plot is beautiful the viewer is more likely to stick with it, to investigate it and to explore the data within. There is a field of psychology known as [the generation effect](https://en.wikipedia.org/wiki/Generation_effect) which describes how people remember things better that they explore and explain to themselves. If you data is super clearly displayed then the user might simply see it but never remember it.
